...
const dropHighways = require('./normalization').dropHighways;
const dropSuffixes = require('./normalization').dropSuffixes;
const dropDirections = require('./normalization').dropDirections;
const dropAbbreviations = require('./normalization').dropAbbreviations;
 ...
 */
function create(uniques, splitter) {
    splitter = splitter || '+';
    const index = new Map();
